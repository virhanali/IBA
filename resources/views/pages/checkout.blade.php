      ...
      <div class="row">
        <div class="col-lg-8 pl-lg-0">
          <div class="card card-details">
            ...
            @endif
            <h1>Complete the document</h1>
            <p>
              Packages {{ $item->travel_package->title }}, {{ $item->travel_package->location }}
            </p>
            <div class="attendee">
            ...
            <div class="member mt-3">
              ...
              <form class="form-inline" method="post" action="{{ route('checkout-create', $item->id) }}">
                ...
                <label for="nationality" class="sr-only">ID</label>
                <input
                  type="text"
                  name="nationality"
                  class="form-control mb-2 mr-sm-2"
                ...
                <label for="is_visa" class="sr-only">Time</label>
                <select
                  name="is_visa"
                  id="is_visa"
                  required
